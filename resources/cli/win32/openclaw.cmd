...
if /i "%1"=="update" (
    echo openclaw is managed by OpenMe ^(bundled version^).
    echo.
    echo To update openclaw, update OpenMe:
    echo   Open OpenMe ^> Settings ^> Check for Updates
    echo   Or download the latest version from https://openme.com
    exit /b 0
)
...
set OPENCLAW_EMBEDDED_IN=OpenMe
